...
// const PAGES = "0xe82b082ba29e7a75298dccfb7c1431c980e9f0c7";
// const MULTICALL_ADDRESS = "0xcA11bde05977b3631167028862bE2a173976CA11";
// const MY_ADDRESS = "0x3D31fa5C9Df0B0F800555FAB474595cE38Ad624e";
...
// //   ids.push(i);
// // }
// // const hasIds = await artGobblerContract.balanceOfBatch(addresses, ids);
// // const myNftIds = hasIds
// //   .map((x, i) => [ethers.BigNumber.from(i), x])
// //   .filter((x) => (x[1] as ethers.BigNumber).toNumber() == 1)
// //   .map((x) => x[0]);
// // const multicallGobblerMultiple = myNftIds.map((id) => {
// //   return {
// //     target: ART_GOBBLERS_ADDRESS,
// //     allowFailure: false,
// //     callData: artGobblerInterface.encodeFunctionData(
...
// // });
// // try {
// //   console.log("MY NFT RANKING");
// //   const callRes = await multicallContract.callStatic.aggregate3(
// //     multicallGobblerMultiple,
// //     {
// //       gasLimit: 1000000000,
// //     }
// //   );
// //   // console.log("callres", callRes);
// //   const rankMyNfts = myNftIds
// //     .map((id, i) => {
// //       return [id.toNumber(), ethers.BigNumber.from(callRes[i].returnData)];
// //     })
// //     .sort((a, b) => (b[1] as ethers.BigNumber).sub(a[1]).toNumber());
// //   rankMyNfts.map(([id, multiple]) =>
// //     console.log(id.toString(), multiple.toString())
// //   );
// //   console.log(rankMyNfts.map(([id, multiple]) => id).slice(0, 69));
// // } catch (e) {
// //   console.log("FAILED TO GET MY NFT RANKING", e);
// // }
