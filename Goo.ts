...
export type GooEvents = 'Approval' | 'Transfer';
export interface GooEventsContext {
  Approval(...parameters: any): EventFilter;
  Transfer(...parameters: any): EventFilter;
}
export type GooMethodNames =
  | 'new'
  | 'DOMAIN_SEPARATOR'
  | 'allowance'
  | 'approve'
...
export interface Goo {
   ...
   * @param _pages Type: address, Indexed: false
   */
  'new'(
    _artGobblers: string,
    _pages: string,
   ...
   * Type: function
   */
  pages(overrides?: ContractCallOverrides): Promise<string>;
  /**
   * Payable: false
   * Constant: false
   * StateMutability: nonpayable
